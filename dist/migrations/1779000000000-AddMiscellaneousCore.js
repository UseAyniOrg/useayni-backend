...
exports.AddMiscellaneousCore1779000000000 = void 0;
class AddMiscellaneousCore1779000000000 {
    ...
    `);
        const existingCols = new Set(miscCols.map((r) => r.column_name));
        const colsToAdd = [
...
exports.AddMiscellaneousCore1779000000000 = AddMiscellaneousCore1779000000000;
