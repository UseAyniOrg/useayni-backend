...
const CaeController_1 = require("../controllers/CaeController");
...
exports.CaeModule = CaeModule = __decorate([
    (0, common_1.Module)({
        controllers: [CaeController_1.CaeController],
        providers: [CaeService_1.CaeService],
        exports: [CaeService_1.CaeService],
    })
], CaeModule);
